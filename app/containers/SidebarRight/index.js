...
import EmojisTab from "../EmojiList";
import MemesTab from "../MemeGenerator";
import ChatbotTab from "../AutoResponder";
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(SidebarRight));
